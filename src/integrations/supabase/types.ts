  ...
  public: {
    Tables: {
      ...
      class_subject_registrations: {
        ...
        Relationships: [
          {
            foreignKeyName: "class_subject_registrations_class_id_fkey"
            columns: ["class_id"]
            isOneToOne: false
            referencedRelation: "classes"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "class_subject_registrations_session_id_fkey"
            columns: ["session_id"]
            isOneToOne: false
            referencedRelation: "sessions"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "class_subject_registrations_subject_id_fkey"
            columns: ["subject_id"]
            isOneToOne: false
            referencedRelation: "subjects"
            referencedColumns: ["id"]
      ...
      goods_receipt_notes: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "goods_receipt_notes_store_id_fkey"
            columns: ["store_id"]
            isOneToOne: false
      ...
      inventory_items: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "inventory_items_default_supplier_fkey"
      ...
      library_fines: {
        Row: {
          ...
          posted_to_finance: boolean | null
          status: string
          student_id: string | null
          updated_at: string | null
        }
        ...
        Relationships: [
          {
            foreignKeyName: "library_fines_issue_id_fkey"
            columns: ["issue_id"]
            isOneToOne: false
            referencedRelation: "library_issues"
            referencedColumns: ["id"]
          },
          {
      ...
      library_members: {
        ...
        Relationships: [
          {
            foreignKeyName: "library_members_employee_id_fkey"
            columns: ["employee_id"]
            isOneToOne: false
            referencedRelation: "hr_employees"
            referencedColumns: ["id"]
      ...
      procurement_invoices: {
        ...
        Relationships: [
          {
            foreignKeyName: "procurement_invoices_grn_id_fkey"
            columns: ["grn_id"]
            isOneToOne: false
            referencedRelation: "goods_receipt_notes"
            referencedColumns: ["id"]
      ...
      procurement_suppliers: {
        ...
        Relationships: [
          {
            foreignKeyName: "procurement_suppliers_account_id_fkey"
            columns: ["account_id"]
            isOneToOne: false
            referencedRelation: "chart_of_accounts"
            referencedColumns: ["id"]
      ...
      purchase_requisitions: {
        ...
        Relationships: [
          {
            foreignKeyName: "purchase_requisitions_source_requisition_id_fkey"
      ...
      stock_transactions: {
        ...
        Relationships: [
          {
            foreignKeyName: "stock_transactions_destination_store_id_fkey"
      ...
      store_requisition_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "store_requisition_items_item_id_fkey"
            columns: ["item_id"]
            isOneToOne: false
            referencedRelation: "inventory_items"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "store_requisition_items_store_id_fkey"
            columns: ["store_id"]
            isOneToOne: false
            referencedRelation: "inventory_stores"
            referencedColumns: ["id"]
